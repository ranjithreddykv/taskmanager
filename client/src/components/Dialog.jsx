...
const ConfirmationDialog = ({open,setOpen,msg,onClick=()=>{},type='delete' ,setMsg=()=>{} ,setType=()=>{}}) => {
    const closeDialog=()=>{
        setType("delete");
        setMsg(null);
        setOpen(false);
...
export const UserAction=({open,setOpen,onClick=()=>{}})=>{
    const closeDialog=()=>{
        setOpen(false);
    }
    return (
            ...
            <ModalWrapper open={open} setOpen={closeDialog}>
                <div className='py-4 w-full flex flex-col gap-4 items-center justify-center'>
                    ...
                    <div className='bg-gray-50 py-3 sm:flex sm:flex-row-reverse gap-4'>
                        <Button
                        type='button'
                        className={clsx("px-8 text-sm font-semibold text-white sm:w-auto","bg-red-600 hover:bg-red-500")}
                        onClick={onClick}
                        label={"Yes"}
                        />
                        <Button
